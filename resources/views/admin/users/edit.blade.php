                    ...
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required {{ auth()->id() == $user->id ? 'disabled' : '' }}>
                                <option value="visitor" {{ old('role', $user->isAdmin() ? 'admin' : 'visitor') == 'visitor' ? 'selected' : '' }}>Visitor</option>
                                <option value="admin" {{ old('role', $user->isAdmin() ? 'admin' : 'visitor') == 'admin' ? 'selected' : '' }}>Administrator</option>
                            </select>
                            @if(auth()->id() == $user->id)
                                <input type="hidden" name="role" value="{{ $user->isAdmin() ? 'admin' : 'visitor' }}">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="active" name="active" value="1" {{ old('active', $user->active ? '1' : '') ? 'checked' : '' }}>
